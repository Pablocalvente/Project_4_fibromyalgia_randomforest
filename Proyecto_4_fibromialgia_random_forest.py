...
# Realiza validación cruzada para calcular la precisión
scores = cross_val_score(model, X_scaled, y, cv=5)  # cv=5 para validación cruzada de 5 pliegues

# Calcula y muestra la precisión promedio
precision_promedio = scores.mean()
print(f"Precisión del modelo (validación cruzada): {precision_promedio:.2f}")
